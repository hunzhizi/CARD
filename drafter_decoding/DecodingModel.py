...
class DecodingModel(nn.Module):
    ...
    def draft(self,
        ...
        input_ids, position_ids, tree_attention_mask, parents = tree.enqueue(torch.softmax(outputs[0], dim=-1, dtype=torch.float32))
        ...
        print(self.tokenizer.decode(tokens_id))